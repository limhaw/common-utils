...
import io.github.sweehaw.exception.IsoException;
...
public class IsoUtils {
    public static final String[] HEX_STRINGS = new String[256];
    /**
     * @deprecated
     */
    ...
    public static String hexdump(byte[] b, int offset, int len) {
        ...
        for (int i = offset; i < len; ++i) {
            hex.append(HEX_STRINGS[b[i] & 255]);
            hex.append(' ');
            char c = (char) b[i];
